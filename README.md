...
You can run the app in Docker
    ...
    docker run -e TELEGRAM_BOT_TOKEN=your-token -e AMAZON_TAG=your-tag --init gfsolone/telegram-bot-amazon
...
If you want to use **Docker Compose**, I have published [here](example/docker-compose.yml) an example that you can use with Portainer. The variables will obviously have to be specified within the software.